...
def serialize_circuit(circuit: cirq.Circuit) -> iqm_client.models.Circuit:
    ...
    return iqm_client.models.Circuit(name='Serialized from Cirq', instructions=instructions)
